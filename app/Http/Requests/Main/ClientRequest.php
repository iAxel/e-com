...
final class ClientRequest extends BaseRequest
{
    /**
     * @return bool
     */
    ...
    public function rules(): array
    {
        return [
            'id' => ['nullable', 'int'],
            'ft_name' => ['nullable', 'string', 'max:255'],
            'lt_name' => ['nullable', 'string', 'max:255'],
            ...
            'sort.by' => ['required_with:sort', 'string', 'max:255', 'in:id,ft_name,lt_name,created_at,updated_at'],
